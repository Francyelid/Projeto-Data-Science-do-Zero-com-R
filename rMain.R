...
# Irá mostrar apensas a primeira imagem das processadas
library(tidyr)
library(ggplot2)
...
# Padronização da escala de 0 à 1
...
# Os rótulos de previsão corretos são verdes e os de previsão incorretos são vermelhos.
par(mfcol=c(5,5))
par(mar=c(0, 0, 1.5, 0), xaxs='i', yaxs='i')
for (i in 1:25) { 
  img <- test_images[i, , ]
